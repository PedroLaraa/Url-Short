    ...
    return (
        <nav className="navbar navbar-dark navbar-expand-lg bg-dark">
            <div className="container-fluid">
                <a className="navbar-brand" href="#Home">🌐URL SHORT</a>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="https://github.com/PedroLaraa/Url-Short">Projeto</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="https://pedro-lara.vercel.app" style={{color: 'green'}}>O Desenvolvedor</a>
                        </li>
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle" role="button" href='#Home' data-bs-toggle="dropdown" aria-expanded="true">
                                Contatos
                            </a>
